...
/**
 * @brief Converts an Eigen::Matrix4f to a geometry_msgs::msg::Pose
 */
inline geometry_msgs::msg::Pose eigenToRosPose(const Eigen::Matrix4f& eigen_pose)
{
...
/**
 * @brief Converts a geometry_msgs::msg::Pose to an Eigen::Matrix4f
 */
inline Eigen::Matrix4f rosPoseToEigen(const geometry_msgs::msg::Pose& ros_pose)
{
    ...
    Eigen::Quaternionf quat(ros_pose.orientation.w, 
